 ...
 * @author Claudiu
 */
public class JIAddProdusInFactura extends javax.swing.JInternalFrame {
    ...
    public JIAddProdusInFactura(MainFrame mf) {
        dq = new DBQueries();
        this.mf = mf;
        initComponents();
    ...
    public void refreshTable(int gestiune, String cauta) {
        ...
        try {
            List<Produs> listp = mf.jiFact.listap;
            listp.stream().forEach((p) -> {
                produse.stream().filter((ps) -> (ps.equals(p))).forEach((ps) -> {
                    ps.setStoc(ps.getStoc() - p.getCantitateIesire()-p.getCantitateFacturata());
                });
            });
    ...
    private void initComponents() {
        ...
        tvaTxt = new javax.swing.JTextField();
        ...
        setTitle("Adauga produs in Factura");
    ...
    jPanel2Layout.setVerticalGroup(
        ...
        .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(tvaTxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addComponent(jLabel3))
            .addGap(5, 5, 5)
    ...
    jButton2.setText("Adauga in Factura");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Produs p = new Produs( denumireTxt.getText(), umTxt.getText(), tvaTxt.getText(), Double.parseDouble(pretUnitarTxt.getText()),  Double.parseDouble(cantiatatetxt.getText()));
        if (p.getCantitateFacturata()> stoc) {
        ...
        List<Produs> lista = mf.jiFact.listap;
        for (int i = 0; i < lista.size(); i++) {
            if (lista.get(i).equals(p)) {
                lista.set(i, p);
                mf.jiFact.refreshTableProduse(mf.jiFact.listap);
                clearText();
                this.hide();
                return;
            }
        }
        mf.jiFact.listap.add(p);
        mf.jiFact.refreshTableProduse(mf.jiFact.listap);
        clearText();
        this.hide();
        return;
    ...
    private javax.swing.JTextField tvaTxt;
