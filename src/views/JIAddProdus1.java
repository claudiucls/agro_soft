 ...
 * @author Claudiu
 */
public class JIAddProdus1 extends javax.swing.JInternalFrame {
    ...
    public JIAddProdus1(MainFrame mf) {
        dq = new DBQueries();
        this.mf = mf;
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        List<Produs> lista = mf.jimn.listap;
        for (int i = 0; i < lista.size(); i++) {
            if (lista.get(i).equals(p)) {
                lista.set(i, p);
                mf.jimn.refreshTableProduse(lista);
                clearText();
                this.hide();
                return;
            }
        }
        mf.jimn.listap.add(p);
        mf.jimn.refreshTableProduse(mf.jimn.listap);
        clearText();
        this.hide();
